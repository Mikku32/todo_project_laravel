    ...
    <div class="max-w-lg mx-auto mt-12 p-6 rounded-lg bg-slate-100 shadow-md">
        <form method="POST" action="{{ route('todoUpdateStore', $todo->id) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" id="title" placeholder="Title please" value="{{ $todo->title }}"
            ...
            <div class="mb-6 flex items-center">
                <input type="checkbox" name="is_completed" id="is_completed"
                    class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" {{ $todo->is_completed ? 'checked' : '' }}>
